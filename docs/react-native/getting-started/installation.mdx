...
Para maior entendimento da utilização do Typography em diferentes sistemas operacionais, consulte a documentação específica
...
Nossa _library_ tem a possibilidade de sobrescrever os estilos definidos por padrão, usados no nosso **Design System**.
...
Para acessar essa propriedade temos que invocar o nosso _custom hook_ de tema e utilizar a propriedade theme dele.
